...
if __name__ == "__main__":
    ...
    test_logfile = "./log/Lorenz_test_{}_T_{}_N_{}_log.log".format(evaluation_mode, T_test, N_test) # Original
    test_jsonfile = "./log/Lorenz_test_{}_T_{}_N_{}_results.json".format(evaluation_mode, T_test, N_test) # Original
    ...
    tikzplotlib.save('./figs/LorenzModel/{}/InferTime_vs_SMNR_Lorenz.tex'.format(evaluation_mode)) # Original
    plt.savefig('./figs/LorenzModel/{}/InferTime_vs_SMNR_Lorenz.pdf'.format(evaluation_mode)) # Original
    ...
    tikzplotlib.save('./figs/LorenzModel/{}/MSE_vs_SMNR_Lorenz.tex'.format(evaluation_mode)) # Original
    plt.savefig('./figs/LorenzModel/{}/MSE_vs_SMNR_Lorenz.pdf'.format(evaluation_mode)) # Original
