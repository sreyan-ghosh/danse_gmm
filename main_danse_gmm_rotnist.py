...
from src.danse_gmm import DANSE_GMM, train_danse
...
def main():
    ...
    batch_size = est_parameters_dict["danse_gmm"]["batch_size"] # Set the batch size
    estimator_options = est_parameters_dict["danse_gmm"] # Get the options for the estimator
    ...
    estimator_options["num_mixtures"] = n_mix # GMM Update # n_mix
    ...
    #NOTE: Currently this is hardcoded into the system # n_mix
    main_exp_name = "{}_danse_opt_{}_m_{}_n_{}_n_mix_{}_T_{}_N_{}_smnr_{}dB".format(
                                                            dataset_type,
                                                            model_type,
                                                            n_states,
                                                            n_obs,
    ...
    if mode.lower() == "train":
        ...
        model_danse = DANSE_GMM(**estimator_options)
        tr_verbose = True  
